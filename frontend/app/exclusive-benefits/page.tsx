...
export default function ExclusiveBenefitsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white font-sans selection:bg-amber-500/30 pb-20 overflow-x-hidden">
        ...
        <section className="mb-48">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div className="relative">
                 ...
                 <div className="relative bg-white/[0.03] border border-white/10 p-12 rounded-[4rem] backdrop-blur-3xl overflow-hidden group">
