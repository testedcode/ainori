...
const PAYMENT_FLOW = [
  ...
  { step: '03', icon: Phone, title: 'Pay via UPI', desc: 'Directly transfer to host\'s UPI. Pulse is not involved.', color: 'text-green-400', bg: 'bg-green-500/10' },
...
const SECURITY_QA = [
  ...
  { q: 'Does Pulse store my UPI ID?', a: 'Your UPI ID is stored in your profile and is only shown to confirmed co-riders on a specific ride. Pulse never initiates or processes any UPI transactions — all payments are purely peer-to-peer between users.', icon: CreditCard, color: 'text-green-400' },
  ...
  { q: 'What data does Pulse collect?', a: 'We collect only what is necessary: name, email, phone, vehicle details (for hosts), and ride activity. We do not collect payment data, location continuously, or sell data to third parties.', icon: Eye, color: 'text-cyan-400' },
]
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-12 pt-20 pb-16">
        <Reveal>
          ...
          <p className="text-slate-400 text-lg max-w-2xl leading-relaxed">
            Pulse is a community-first platform. Every feature we build starts with one question — <em className="text-white">is this safe for our users?</em> Here is exactly how we protect you.
          </p>
        </Reveal>
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 p-4 bg-white/5 border border-white/10 rounded-2xl">
                <p className="text-[11px] text-slate-400 text-center leading-relaxed">
                  <span className="font-black text-white">Important:</span> Pulse only records whether users have <em>marked</em> a payment as done — not the actual transaction. We have zero visibility into UPI transaction data.
                </p>
              </div>
            </div>
          </div>
