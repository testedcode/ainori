...
export default function JoolFooter() {
  return (
    <footer className="bg-[#080f1e] border-t border-white/5 text-white font-sans">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-black tracking-tight">JOOL</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[['Safety Policy', '#'], ['Terms of Service', '#'], ['Privacy Policy', '#'], ['Support', '#']].map(([label, href]) => (
                <li key={label}>
                  <Link href={href} className="text-sm text-slate-400 hover:text-white transition-colors">{label}</Link>
                </li>
              ))}
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-600">© 2026 JOOL Carpooling Platform. All rights reserved.</p>
