      ...
      <div className="w-full pt-32 pb-8 overflow-x-auto scrollbar-hide">
         <div className="flex items-center justify-start gap-10 px-12 min-w-max">
            ...
            <button 
              ...
              className="group flex flex-col items-center gap-4 transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer"
            >
               <div className={`w-20 h-20 rounded-full overflow-hidden transition-all duration-500 border-2 relative ${filter.direction === 'to_office' ? `bg-white ${theme.accent.replace('text-', 'border-')} scale-110 shadow-[0_0_30px_rgba(255,255,255,0.3)]` : 'bg-white/5 border-white/10 hover:border-white/30'}`}>
                  ...
                  {filter.direction === 'to_office' && <div className="absolute inset-0 bg-white/10 pointer-events-none" />}
               </div>
            ...
            <button 
              ...
              className="group flex flex-col items-center gap-4 transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer"
            >
               <div className={`w-20 h-20 rounded-full overflow-hidden transition-all duration-500 border-2 relative ${filter.direction === 'to_home' ? `bg-white ${theme.accent.replace('text-', 'border-')} scale-110 shadow-[0_0_30px_rgba(255,255,255,0.3)]` : 'bg-white/5 border-white/10 hover:border-white/30'}`}>
                  ...
                  {filter.direction === 'to_home' && <div className="absolute inset-0 bg-white/10 pointer-events-none" />}
               </div>
