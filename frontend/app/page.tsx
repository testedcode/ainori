...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#060b18] text-white overflow-x-hidden font-sans selection:bg-blue-600/30">
      {/* Premium Navbar */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 px-6 md:px-12 py-4 flex justify-between items-center ${
        scrolled ? 'bg-[#060b18]/80 backdrop-blur-2xl border-b border-white/5 py-3' : 'bg-transparent'
      }`}>
