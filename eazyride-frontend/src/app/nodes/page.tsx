  ...
  return (
    <div className="min-h-screen bg-blue-600 text-white selection:bg-blue-200">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="mb-20">
          <p className="text-blue-600 font-black text-[10px] uppercase tracking-[0.4em] mb-6">OUR COMMUNITY NETWORK</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
           {nodes.map((node, i) => (
             <div key={i} className="relative group">
                <div className="absolute inset-0 bg-blue-50 blur-[50px] -z-10 group-hover:bg-blue-100 transition-colors" />
                <div className="bg-white border border-slate-200 p-10 rounded-[3rem] h-full flex flex-col items-center text-center group-hover:border-blue-500/30 transition-all">
        ...
        <div className="mt-20 flex flex-col items-center">
           <div className="w-px h-20 bg-gradient-to-b from-blue-600 to-white mb-12" />
           <div className="inline-flex items-center gap-3 px-6 py-3 bg-white border border-slate-200 rounded-full text-[10px] font-black uppercase tracking-[0.3em]">
      ...
      <footer className="py-20 border-t border-slate-200 text-center">
        <p className="text-[10px] font-black text-slate-700 uppercase tracking-widest">© 2026 • BUILT FOR OUR COMMUNITY • CRAFTED IN INDIA</p>
      </footer>
    </div>
  )
}
