    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-blue-200">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="mb-20 pt-16">
          <p className="text-blue-600 font-black text-[10px] uppercase tracking-[0.4em] mb-6">COMMUNITY AGREEMENT</p>
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter italic uppercase italic leading-none mb-8">
            COMMUNITY<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-500 to-indigo-600">TERMS.</span>
          </h1>
        ...
        <div className="space-y-12">
           {sections.map((s, i) => (
             <section key={i} className="border-l-2 border-slate-200 pl-8 md:pl-12 py-4">
        ...
        <div className="mt-20 p-10 bg-white border border-slate-200 rounded-[2rem] text-sm text-slate-700 leading-relaxed font-medium">
      ...
      <footer className="py-20 border-t border-slate-200 text-center">
        <p className="text-[10px] font-black text-slate-700 uppercase tracking-widest">© 2026 • COMMUNITY TERMS • CRAFTED IN INDIA</p>
      </footer>
    </div>
  )
}
